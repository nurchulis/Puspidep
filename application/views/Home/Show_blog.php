<div id="colorlib-main">
  <div class="colorlib-work">
    <div class="colorlib-narrow-content">
      <div class="row">
        <?php foreach ($tampil_blog_id as $tampil)  {
         ?>
        <div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
          <span class="heading-meta">Home/Blog/<?php echo $tampil->judul_blog ?></span>
          <h2 class="colorlib-heading"><?php echo $tampil->judul_blog ?></h2>
        </div>
      </div>
      <div class="row">
        <div class="col-md-8">
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="colorlib-feature animate-box" data-animate-effect="fadeInLeft">
                <img class="img-responsive" src="<?php echo base_url() ?>Assets/images/Kiriman/<?php echo $tampil->gambar_blog ?>">
                <br>
