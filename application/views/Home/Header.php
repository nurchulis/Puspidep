		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul class="primary-nav">
					...
					<li><a href="<?php echo base_url() ?>Halaman/About">About</a></li>
					<li><a href="<?php echo base_url() ?>Halaman/Portofolio">Portofolio</a></li>
					<li><a href="<?php echo base_url() ?>Halaman/Blog">Blog</a></li>
					<li><a href="<?php echo base_url() ?>Halaman/Contact">Contact Us</a></li>
				</ul>
			</nav>
