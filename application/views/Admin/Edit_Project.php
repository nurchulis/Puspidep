...
<div class="row">
    ...
    <div class="col-md-8">
      ...
      <?php foreach ($ambil_project as $tampil) {
       ?>
      <?php echo form_open_multipart('Kirim/edit_project');?>
                <form method="post" action="<?php echo base_url(); ?>Kirim/edit_project" name="kirimanlur" enctype="multipart/form-data">  
      <input type="text" style="margin-bottom:15px;" class="form-control" name="judul_project" value="<?php echo $tampil->judul_project ?>"   required autofocus>
      <input type="hidden" name="id_project" value="<?php echo $tampil->id_project_post ?>">
      <input type="hidden" name="gambar_lama" value="<?php echo $tampil->gambar_project ?>">
      <div class="panel-body" style="padding:0px;">
									<textarea id="summernote" name="isi"  required/><?php echo $tampil->isi_project ?></textarea>
        ...
        <!-- PANEL NO PADDING -->
							<div class="panel">
								...
								<div class="panel-body">
									...
									Upload Cover Project</p>
									<img src="<?php echo base_url() ?>Assets/images/Kiriman/thumb/<?php echo $tampil->gambar_project ?>" width="240px">
