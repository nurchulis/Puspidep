...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Posting Blog</h4> </div>
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      <ol class="breadcrumb">
                          <li><a href="#">Posting Blog</a></li>
                      </ol>
...
<div class="row">
    ...
    <div class="col-md-8">
      ...
      <?php echo form_open_multipart('Kirim/post_blog');?>
                <form method="post" action="<?php echo base_url(); ?>Kirim/post_blog" name="kirimanlur" enctype="multipart/form-data">  
      <input type="text" style="margin-bottom:15px;" class="form-control" name="judul_blog" placeholder="Tuliskan Judul"  required autofocus>
