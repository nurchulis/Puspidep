...
<div class="row">
    ...
    <div class="col-md-8">
      ...
      <?php echo form_open_multipart('Kirim/post_project');?>
                <form method="post" action="<?php echo base_url(); ?>Kirim/post_project" name="kirimanlur" enctype="multipart/form-data">  
      <input type="text" style="margin-bottom:15px;" class="form-control" name="judul_project" placeholder="Tuliskan Judul"  required autofocus>
